/**
 * 签文池
 * 每条包含：name（短签名，如"随便改就它签"）、level（吉/凶）、text（签文内容）
 */

export const signPool = [
...
/** 选签文（按种子稳定） */
export function pickSign(seed) {
  let s = (seed * 9301 + 49297) % 233280
  const r = s / 233280
  return signPool[Math.floor(r * signPool.length)]
}

export default signPool
